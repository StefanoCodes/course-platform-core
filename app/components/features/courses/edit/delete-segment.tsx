...
export function DeleteSegment({ segmentId, courseSlug }: { segmentId: string, courseSlug: string }) {
    ...
    return (
        <DeleteDialog
            ...
            trigger={
                <Button type="button" variant="outline" className="cursor-pointer w-fit text-red-400 hover:text-red-500 self-center h-10">
                    Delete Segment
                </Button>
            }
            onSuccess={() => {
