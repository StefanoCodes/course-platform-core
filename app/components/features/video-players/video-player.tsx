...
function VimeoPlayer({url}:{
    ...
    return (
       <iframe src={`https://player.vimeo.com/${extractVimeoVideoId(url)}`} frameBorder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media" title="My Video"/>
    )
}