...
import { handleCreateSegment, handleEditSegment, handleDeleteSegment } from "~/lib/actions/segment/segment.server"


const intents = ["create-segment", "edit-segment", "delete-segment"]
